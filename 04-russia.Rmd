...
```{r}
model_dev_ethnic <- lm(deviance_region ~  ethnic_status +  ur_gov_share + subnational_party_control   + presidential +pensioners_per_1000 + grp_by_pop +  poverty + urban_pct  + n_precincts , data = full_data)
summary(model_dev_ethnic)



model_dev_pctrus <- lm(deviance_region ~  pct_russian_upd +  ur_gov_share + subnational_party_control    + presidential +pensioners_per_1000 + grp_by_pop +  poverty + urban_pct  + n_precincts  , data = full_data)
summary(model_dev_pctrus)


model_dev_regcomp <- lm(deviance_region ~  regional_comp +  ur_gov_share + subnational_party_control    + presidential +pensioners_per_1000 + grp_by_pop +  poverty + urban_pct  + n_precincts  , data = full_data)
...
```{r}
model_spike_ethnic <- lm(spikes_est_adj ~  ethnic_status +  ur_gov_share + subnational_party_control   + presidential +pensioners_per_1000 + grp_by_pop +  poverty + urban_pct  + population , data = full_data)
summary(model_spike_ethnic)



model_spike_pctrus <- lm(spikes_est_adj ~  pct_russian_upd +  ur_gov_share + subnational_party_control    + presidential +pensioners_per_1000 + grp_by_pop +  poverty + urban_pct  + population  , data = full_data)
summary(model_spike_pctrus)


model_spike_regcomp <- lm(spikes_est_adj ~  regional_comp +  ur_gov_share + subnational_party_control    + presidential +pensioners_per_1000 + grp_by_pop +  poverty + urban_pct  + population  , data = full_data)
